...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            option.setTextColor(Color.parseColor("#7A8098"))
...
//ContextCompat:::
//getContext().getColor(R.color.black); <--before
//after android 6.0 --> getContext().getColor(R.color.black,theme);
//or use ContextCompat which fill theme automatically depends on your Context's theme:::
//ContextCompat.getColor(getContext(),R.color.black)
//ContextCompat contains other methods for functional of API 22+ such as checking permissions or adding multiple activity to stack